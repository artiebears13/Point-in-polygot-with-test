...
string ans_in = "The point(x, y) is inside of the polygon";
string ans_on = "The point(x, y) is outside of the polygon";
string ans_out = "The point (x, y) is on the edge of the poly";
